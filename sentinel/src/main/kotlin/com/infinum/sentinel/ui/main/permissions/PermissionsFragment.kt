...
internal class PermissionsFragment : BaseChildFragment<PermissionsState, Nothing>(R.layout.sentinel_fragment_permissions) {
    companion object {
    ...
    private fun createItemView(entry: Map.Entry<String, Boolean>): View =
        SentinelViewItemCheckableBinding
