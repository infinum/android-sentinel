...
internal class PreferencesAdapter(
    ...
    companion object {
        ...
        val diffItemCallback =
            object : DiffUtil.ItemCallback<PreferencesItem>() {
                override fun areItemsTheSame(
                    oldItem: PreferencesItem,
                    newItem: PreferencesItem,
                ): Boolean =
                    when {
    ...
    override fun onCreateViewHolder(
        ...
        if (viewType == PARENT_TYPE) {
            val binding =
                SentinelViewItemPreferenceBinding.inflate(
    ...
    override fun onBindViewHolder(
        ...
        when (val item = getItem(position)) {
            is PreferencesItem.Parent -> {
                (holder as PreferenceParentViewHolder).bind(
                    data = item,
            ...
            is PreferencesItem.Child -> {
                (holder as PreferenceChildViewHolder).bind(
                    data = item,
