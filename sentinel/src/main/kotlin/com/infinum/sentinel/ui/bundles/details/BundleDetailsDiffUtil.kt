...
internal class BundleDetailsDiffUtil : DiffUtil.ItemCallback<BundleTree>() {
    ...
    override fun areItemsTheSame(oldItem: BundleTree, newItem: BundleTree): Boolean {
        return oldItem.id == newItem.id
    }

    override fun areContentsTheSame(oldItem: BundleTree, newItem: BundleTree): Boolean {
