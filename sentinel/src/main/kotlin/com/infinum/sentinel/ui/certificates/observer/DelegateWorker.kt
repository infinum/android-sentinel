...
internal class DelegateWorker(
    ...
    override fun startWork(): ListenableFuture<Result> =
        if (delegatedWorker != null) {
            delegatedWorker.startWork()
        } else {
            val errorMessage =
                "No delegateWorker available for $workerId" +
    ...
    companion object {
        ...
        val workerFactories =
            object : AbstractMutableMap<String, WorkerFactory>() {
                ...
                override fun put(
                    key: String,
                    value: WorkerFactory,
                ): WorkerFactory? = backingWorkerMap.put(key, value)
