...
internal fun Context.enableShakeTrigger(): Boolean? = enableTrigger(KEY_TRIGGER_SHAKE)

internal fun Context.enableProximityTrigger(): Boolean? = enableTrigger(KEY_TRIGGER_PROXIMITY)

internal fun Context.enableForegroundTrigger(): Boolean? = enableTrigger(KEY_TRIGGER_FOREGROUND)

internal fun Context.enableUsbConnectedTrigger(): Boolean? = enableTrigger(KEY_TRIGGER_USB_CONNECTED)

internal fun Context.enableAirplaneModeOnTrigger(): Boolean? = enableTrigger(KEY_TRIGGER_AIRPLANE_MODE_ON)

internal val Context.applicationName: String
    get() =
        (packageManager.getApplicationLabel(this.info) as? String)
