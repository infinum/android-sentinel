...
internal abstract class ViewModelComponent(
    ...
    @IntoMap
    @Provides
    fun sentinel(): Pair<Class<*>, ViewModel> = SentinelViewModel::class.java to sentinel

    @IntoMap
    @Provides
    fun device(): Pair<Class<*>, ViewModel> = DeviceViewModel::class.java to device

    @IntoMap
    @Provides
    fun application(): Pair<Class<*>, ViewModel> = ApplicationViewModel::class.java to application

    @IntoMap
    @Provides
    fun permissions(): Pair<Class<*>, ViewModel> = PermissionsViewModel::class.java to permissions

    @IntoMap
    @Provides
    fun targetedPreferences(): Pair<Class<*>, ViewModel> = PreferencesViewModel::class.java to targetedPreferences

    @IntoMap
    @Provides
    fun preferenceEditor(): Pair<Class<*>, ViewModel> = PreferenceEditorViewModel::class.java to preferenceEditor

    @IntoMap
    @Provides
    fun tools(): Pair<Class<*>, ViewModel> = ToolsViewModel::class.java to tools

    @IntoMap
    @Provides
    fun settings(): Pair<Class<*>, ViewModel> = SettingsViewModel::class.java to settings

    @IntoMap
    @Provides
    fun bundles(): Pair<Class<*>, ViewModel> = BundlesViewModel::class.java to bundles

    @IntoMap
    @Provides
    fun bundleDetails(): Pair<Class<*>, ViewModel> = BundleDetailsViewModel::class.java to bundleDetails

    @IntoMap
    @Provides
    fun crashes(): Pair<Class<*>, ViewModel> = CrashesViewModel::class.java to crashes

    @IntoMap
    @Provides
    fun crashDetails(): Pair<Class<*>, ViewModel> = CrashDetailsViewModel::class.java to crashDetails

    @IntoMap
    @Provides
    fun certificates(): Pair<Class<*>, ViewModel> = CertificatesViewModel::class.java to certificates

    @IntoMap
    @Provides
    fun certificateDetails(): Pair<Class<*>, ViewModel> = CertificateDetailsViewModel::class.java to certificateDetails
}
